...
{% image "/images/gallery/santiago2.jpg", "Santiago2", "(min-width: 900px) 760px, 100vw", [500, 760, 1200] %}
...
{% image "/images/gallery/santiago3.jpg", "Santiago3", "(min-width: 900px) 760px, 100vw", [500, 760, 1200] %}
...
{% image "/images/gallery/santiago4.jpg", "Santiago4", "(min-width: 900px) 760px, 100vw", [500, 760, 1200] %}
...
{% image "/images/gallery/santiago5.jpg", "Santiago5", "(min-width: 900px) 760px, 100vw", [500, 760, 1200] %}
...
{% image "/images/gallery/santiago6.jpg", "Santiago6", "(min-width: 900px) 760px, 100vw", [500, 760, 1200] %}

And of course, me and my favorite Germans: Franca and Matilde. I ran into them right after running into Jim and Kathy.

{% image "/images/gallery/santiago7.jpg", "Santiago7", "(min-width: 900px) 760px, 100vw", [500, 760, 1200] %}

Karaoke!

{% image "/images/gallery/santiago8.jpg", "Santiago8", "(min-width: 900px) 760px, 100vw", [500, 760, 1200] %}
